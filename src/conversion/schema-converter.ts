...
export class SchemaConverter {
   ...
   */
  private processPathsStructure(paths: any): any {
    ...
    for (const [path, pathObj] of Object.entries<any>(paths)) {
      ...
      for (const [key, value] of Object.entries<any>(pathObj)) {
   ...
   */
  private processHttpMethod(method: any): any {
    const processedMethod: any = { ...method };
   ...
   */
  private processRequestBody(requestBody: any): any {
    if (!requestBody || !requestBody.content) {
      return requestBody;
    }
    
    const processedRequestBody: any = { ...requestBody };
    
    // Process content types (application/json, etc.)
    for (const [contentType, contentObj] of Object.entries<any>(requestBody.content)) {
   ...
   */
  private processSchemaProperties(properties: any): any {
    const processedProperties: any = {};
    
    for (const [propName, propObj] of Object.entries<any>(properties)) {
   ...
   */
  private generateMockSchema(namespace: 'pos' | 'common'): any {
   ...
   */
  convertJsonSchemaToZodSchema(jsonSchema: any): string {
   ...
   */
  private convertObjectSchema(schema: any): string {
   ...
   */
  private convertArraySchema(schema: any): string {
   ...
   */
  private convertStringSchema(schema: any): string {
   ...
   */
  private convertNumberSchema(schema: any): string {
   ...
   */
  private convertBooleanSchema(schema: any): string {
    return 'z.boolean()';
  }
   ...
   */
  private convertEnumSchema(schema: any): string {
   ...
   */
  private convertUnionSchema(schema: any): string {
    ...
    const unionTypes = schemas.map((s: any) => this.convertJsonSchemaToZodSchema(s));
   ...
   */
  private convertIntersectionSchema(schema: any): string {
    ...
    const intersectionTypes = schemas.map((s: any) => this.convertJsonSchemaToZodSchema(s));
   ...
   */
  private convertRefSchema(schema: any): string {
